    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1300px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
            ...
            <div className='col-span-2'>
                <span className="text-[#20B486] text-3xl font-bold">AtlasList</span>
                <h3 className='text-2xl font-bold mt-10'>Contact Us</h3>
                <h3 className='py-2 text-[#6D737A]'>Call : +61 401 079 814</h3>
                <h3 className='py-2 text-[#6D737A]'>faster connection with quality services<br></br> We have a network of clients needing services and a large pool of workforce.</h3>
                <h3 className='py-2 text-[#363A3D]'>Email: support@atlaslist.com</h3>
            ...
            <div>
                ...
                <ul className='py-6 text-[#6D737A]'>
                    <li className='py-2'>Offer Support</li>
                    <li className='py-2'>Need Support</li>
            ...
            <div className='max-[780px]:col-span-2'>
                ...
                <h3 className='py-2 text-[#6D737A]'>Get our newsletter <br></br> Get notifications and recommendations.</h3>
                <form className='py-4'>
                    <input 
